...
class AllPopularArticles extends React.Component {
  constructor(props) {
    super(props);
  ...
  getSuggestedFriends = () => {
    getPopularBlogs({ limit: this.state.limit, page: this.state.page }).then(
      (resp) => {
        this.setState(
          ...
          <div className="row mt-2">
            ...
            <div className="col-sm empty-container-with-out-border center-column">
              <div className="empty-container-with-border w-100 popularArticles">
                <h3 className="title border-bottom pb-2">Popular Blogs</h3>
                          ...
                          <li className="list-group-item">
                            <div className="media d-flex align-items-center">
                              <div className="media-left">
                                <A href={`/blog/${e.slug}`}>
                                  {e.contents[0] &&
                                    e.contents[0].content_url !== undefined && (
                                      <div
                                        className="thumbnail"
                                        style={{
                ...
                {this.state.showSkeleton && (
                  <ul className="list-group popular_item w-100">
                    <li className="list-group-item">
                      {Array(3)
                        .fill()
                        .map((item, index) => (
...
export default AllPopularArticles;
