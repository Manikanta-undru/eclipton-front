...
class ViewGroup extends React.Component {
  ...
  render() {
    ...
    const { extend_payment_status } = this.state.paymentDet;
            ...
            <div className="col-sm empty-container-with-out-border center-column">
              <Alert variant="danger">
                ...
                <p>
                  ...
                  <Alert.Link href={`/settings/${this.props.match.params.id}`}>
                    {' '}
                    Clik here to pay{' '}
                  </Alert.Link>{' '}
                    ...
                    {this.state.paymentDet.due_payment_status == 'Overdue' ? (
                      <Alert variant="warning" dismissible>
                        ...
                        <p className="mb-0">
                          ...
                          , if you lost to pay the amount, this group activites
                          are goes to disable
                        </p>
                      </Alert>
                    ) : null}
